...
while option=='Si':
    ...
    ValorHorasTSemana=int(input('Ingrese el valor de por hora de trabajo: '))
    HorasTSemana1=int(input('Ingrese las horas trabajadas en la Semana 1: '))
    HorasTSemana2=int(input('Ingrese las horas trabajadas en la Semana 2: '))
    HorasTSemana3=int(input('Ingrese las horas trabajadas en la Semana 3: '))
    HorasTSemana4=int(input('Ingrese las horas trabajadas en la Semana 4: '))
